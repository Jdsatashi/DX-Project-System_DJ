# Generated by Django 5.0.3 on 2024-04-27 10:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_list_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_price_list', to='price_list.pricelist')),
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_product', to='price_list.productprice')),
            ],
        ),
    ]
